...
TARGET_BOOTLOADER_BOARD_NAME := Aquaris_M45
...
# Kernel
TARGET_PREBUILT_KERNEL := device/bq/dende/kernel
BOARD_CUSTOM_BOOTIMG_MK := device/bq/dende/mkbootimg.mk
...
# TWRP-Specific
TARGET_RECOVERY_FSTAB := device/bq/dende/recovery/etc/twrp.fstab
